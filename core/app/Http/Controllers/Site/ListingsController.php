...
class ListingsController extends PageQueryViewController
{
    ...
    public function index()
    {
        ...
        return view('site.listings.index', compact('datas', 'page', 'seo'));
    }
    ...
    public function indexCategory()
    {
        ...
        return view('site.listings.index', compact('datas', 'page', 'category', 'seo'));
    }
    ...
    public function show()
    {
        ...
        return view('site.listings.show-sidebar', compact('data', 'page', 'seo', 'viewRegister'));
    }
}
