...
use App\Page;
use App\Advert as Model;
use Illuminate\Http\Request;
use App\Http\Requests\AdvertFormRequest as FormRequest;
...
class AdvertsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.adverts.index', compact('page', 'records'));
    }
    ...
    {
        $page = $this->getPage();
        return view('admin.adverts.form', compact('page'));
    }
    ...
    public function show(int $id)
    {
        ...
        return view('admin.adverts.show', compact('page', 'record'));
    }
    ...
    public function edit(int $id, Request $request)
    {
        ...
        $view = !is_null($imageIndex) ? 'supports.images.caption' : 'admin.adverts.form';
    ...
    public function update(FormRequest $request, string $id)
    {
        ...
        // Se não existir esse campo entende-se que foi removido as opcoes
        if (!$request->has('optional')) {
            $request->merge(['optional' => null]);
        }

        if (!$request->has('phones')) {
            $request->merge(['phones' => null]);
        }
