...
use App\Http\Requests\PromotionFormRequest as FormRequest;
...
class PromotionsController extends Controller
{
    ...
    {
        return $this->model->with('media', 'page', 'participants')->where('page_id', optional($page)->id);
    }
    ...
    public function index()
    {
        ...
        return view('admin.promotions.index', compact('page', 'records'));
    }
    ...
    {
        $page = $this->getPage();
        return view('admin.promotions.form', compact('page'));
    }
    ...
    public function show(int $id)
    {
        ...
        return view('admin.promotions.show', compact('record'));
    }
    ...
    public function edit(int $id)
    {
        ...
        return view('admin.promotions.form', compact('page', 'record'));
    }
