...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'publish'               => 'publicar',
        'commentable'           => 'permitir comentários',
        'user_id'               => 'usuário',
        ...
        'seo_keywords'          => 'SEO palavras-chaves',
        'slug'                  => 'slug',
        'url'                   => 'URL',
        'uri'                   => 'URL',
        'author'                => 'autor',
        'source'                => 'fonte',
        'published_at'          => 'data da postagem',
        'unpublished_at'        => 'postagem expira',
        'email'                 => 'e-mail',
        'password'              => 'senha',
        'file'                  => 'arquivo',
        'file_mobile'           => 'arquivo mobile',
        'size'                  => 'tamanho',
        'position'              => 'posição',
        'parent_id'             => 'filho de',
        'started_at'            => 'iniciar em',
        'finished_at'           => 'terminar em',
        'city_id'               => 'cidade',
        'writer.name'           => 'nome do escritor',
        'writer.description'    => 'descrição do escritor',
        'writer.email'          => 'e-mail do escritor',
        'writer.url'            => 'url do escritor',
        'uses_writer'           => 'mostrar dos de escrior',
        'cover'                 => 'capa',  
    ],
];
