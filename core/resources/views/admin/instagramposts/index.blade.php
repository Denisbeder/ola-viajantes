...
<div class="row">
    ...
    <div class="col-lg-6 d-flex align-items-start justify-content-end">
        <div class="form-row justify-content-end">
            <div class="col-auto">
                @include('admin._clear-cache-btn', ['model' => 'InstagramPost'])
            </div>
            <div class="col">
                <a href="/linkbio" target="_blank" class="btn btn-primary">Acessar Links BIO</a>
            </div>
        </div>
    </div>
    @endif
...
<div class="bgc-white bd bdrs-3">
    @include('admin.instagramposts._table')
    <div class="p-20">
        <div class="row">
